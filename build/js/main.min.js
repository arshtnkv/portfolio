  ...
  _createClass(NavigationChanger, [{
    ...
    value: function _changeLinksActiveState() {
      ...
      this._linkElements.forEach(function (link, index) {
        ...
        if (currentBlockElement.getBoundingClientRect().bottom > _this3._blockShift && currentBlockElement.getBoundingClientRect().top <= _this3._blockShift) {
          link.classList.add('is-active');
        } else {
          link.classList.remove('is-active');
        }
        if (document.body.getBoundingClientRect().bottom - window.innerHeight < _this3._blockShift && currentBlockElement.getBoundingClientRect().top > _this3._blockShift) {
          _this3._linkElements[index - 1].classList.remove('is-active');
          link.classList.add('is-active');
        }
      });
    }
    ...
    value: function _removeLinkAnimation() {
      var _this4 = this;
      this._linkElements.forEach(function (link, index) {
        if (index !== _this4._currentIndex && index !== _this4._newCurrentIndex) {
          link.classList.add('is-inactive');
        }
      });
    }
    ...
    value: function _initMoveTo() {
      ...
      this._linkElements.forEach(function (link, index) {
        link.addEventListener('click', function (evt) {
          ...
          _this5._newCurrentIndex = index;
          _this5._moveTo.move(target);
          _this5._removeLinkAnimation();
          setTimeout(function () {
            _this5._addLinkAnimation();
          }, _this5._scrollDuration);
        });
      });
    }
  }]);
...
var navigationChanger = new NavigationChanger();
...
/* harmony import */ var _modules_header_fixed__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header-fixed */ "./js/modules/header-fixed.js");
/* harmony import */ var _modules_preloader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/preloader */ "./js/modules/preloader.js");
...
/* harmony import */ var _modules_init_btn_scroll_up__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-btn-scroll-up */ "./js/modules/init-btn-scroll-up.js");
/* harmony import */ var _modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-navigation-changer */ "./js/modules/init-navigation-changer.js");
/* harmony import */ var _modules_init_anime__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-anime */ "./js/modules/init-anime.js");
/* harmony import */ var _modules_init_sphere__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-sphere */ "./js/modules/init-sphere.js");
/* harmony import */ var _modules_init_hover3d__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-hover3d */ "./js/modules/init-hover3d.js");
...
/* harmony import */ var _modules_init_parallax__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-parallax */ "./js/modules/init-parallax.js");
/* harmony import */ var _modules_init_lazy_loading__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-lazy-loading */ "./js/modules/init-lazy-loading.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header_fixed__WEBPACK_IMPORTED_MODULE_3__["headerFixed"])();
  setTimeout(function () {
    Object(_modules_init_sphere__WEBPACK_IMPORTED_MODULE_9__["initSphere"])();
  }, 3000);
  Object(_modules_init_hover3d__WEBPACK_IMPORTED_MODULE_10__["initHover3d"])();
  Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_5__["initMenu"])();
  Object(_modules_init_btn_scroll_up__WEBPACK_IMPORTED_MODULE_6__["initBtnScrollUp"])();
  Object(_modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_7__["initNavigationChanger"])();
  Object(_modules_init_anime__WEBPACK_IMPORTED_MODULE_8__["initAnime"])();
  Object(_modules_init_parallax__WEBPACK_IMPORTED_MODULE_12__["initParallax"])();
  Object(_modules_init_lazy_loading__WEBPACK_IMPORTED_MODULE_13__["initLazyLoad"])();
  window.addEventListener('load', function () {
    Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_4__["initPreloader"])();
    Object(_modules_init_map__WEBPACK_IMPORTED_MODULE_11__["initMapBlock"])();
...
/*!**********************************!*\
  !*** ./js/modules/init-anime.js ***!
  \**********************************/
/*! exports provided: initAnime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAnime", function() { return initAnime; });
/* harmony import */ var _vendor_anime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/anime */ "./js/vendor/anime.js");
/* harmony import */ var _vendor_anime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__);

var initAnime = function initAnime() {
  ...
  texts.forEach(function (text) {
    ...
    var animeTitle = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
      targets: '.text span',
      easing: 'easeOutExpo'
    });
    animeTitle.add({
      ...
      opacity: [0, 1],
      duration: 1500,
      delay: Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["stagger"])(100)
    });
  });
  var animeIcon = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
    targets: '#btn-github',
    easing: 'easeOutCirc'
  });
  animeIcon.add({
  ...
  var btnCV = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
    targets: '#btn-cv',
    easing: 'easeOutCirc'
  });
  btnCV.add({
  ...
  var btnWork = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
    targets: '#btn-work',
    easing: 'easeOutCirc'
  });
  btnWork.add({
...
/*!******************************************!*\
  !*** ./js/modules/init-btn-scroll-up.js ***!
  \******************************************/
/*! exports provided: initBtnScrollUp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBtnScrollUp", function() { return initBtnScrollUp; });
var initBtnScrollUp = function initBtnScrollUp() {
  var btn = document.querySelector('[data-btn-up]');
  if (!btn) {
    return;
  }
...
/*!************************************!*\
  !*** ./js/modules/init-hover3d.js ***!
  \************************************/
/*! exports provided: initHover3d */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHover3d", function() { return initHover3d; });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var initHover3d = function initHover3d() {
  var nodes = [].slice.call(document.querySelectorAll('.works__gallery .card'), 0);
  var directions = {
    0: 'top',
    1: 'right',
    2: 'bottom',
  ...
  var HovItem = /*#__PURE__*/function () {
    function HovItem(element) {
      var _this = this;
      _classCallCheck(this, HovItem);
...
/*!********************************!*\
  !*** ./js/modules/init-map.js ***!
  \********************************/
/*! exports provided: initMapBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMapBlock", function() { return initMapBlock; });
var MAP_URL = 'https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=5e855f52-3b66-497c-8633-552f90c58837';
var mapBlock;
var isLoaded = false;
var map;
var interval;
var initMap = function initMap() {
  var lng = mapBlock.dataset.longitude || 55.713669;
  var lat = mapBlock.dataset.latitude || 37.573169;
  var zoom = mapBlock.dataset.zoom || 15;
  var pin = mapBlock.dataset.pin || 'img/svg/map-pin.svg';
  window.ymaps.ready(function () {
    ...
    var placemark = new window.ymaps.Placemark([lng, lat], {}, {
...
var initMapBlock = function initMapBlock() {
...
var initMenu = function initMenu() {
  ...
  var burger = nav.querySelector('.nav__toggle');
  var btns = nav.querySelectorAll('.nav__item button');
...
/* harmony import */ var _inline_ui_kit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../inline/ui-kit */ "./js/inline/ui-kit.js");
/* harmony import */ var _inline_ui_kit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_inline_ui_kit__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_navigation_changer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/navigation-changer */ "./js/components/navigation-changer.js");


var initNavigationChanger = function initNavigationChanger() {
  var navigationChanger = new _components_navigation_changer__WEBPACK_IMPORTED_MODULE_1__["NavigationChanger"]();
  navigationChanger.init();
};
...
/* harmony import */ var _vendor_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vendor/ScrollSmoother */ "./js/vendor/ScrollSmoother.js");
/* harmony import */ var _vendor_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__);



var initParallax = function initParallax() {
  _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"], _vendor_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__["ScrollSmoother"]);
  var btnsWorks = document.querySelectorAll('[data-btn="works"]');
  var btnContact = document.querySelector('[data-btn="contact"]');
  var leftItems = _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray('.card--left');
  var rightItems = _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray('.card--right');
  var centerItems = _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray('.card--center');
  if (_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].isTouch !== 1) {
    _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].normalizeScroll();
    var smoother = _vendor_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__["ScrollSmoother"].create({
      wrapper: '.app',
      content: '.wrapper',
      smooth: 5,
      effects: true
    ...
    if (btnsWorks && btnContact) {
      btnsWorks.forEach(function (btn) {
    ...
    _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo('.header', {
      opacity: 1
    }, {
      opacity: 0,
      scrollTrigger: {
    ...
    _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo('.works', {
      opacity: 1
    }, {
      opacity: 0,
      scrollTrigger: {
    ...
    rightItems.forEach(function (item) {
      _vendor_gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo(item, {
        x: 350
      }, {
        x: 0,
        scrollTrigger: {
...
/*!***********************************!*\
  !*** ./js/modules/init-sphere.js ***!
  \***********************************/
/*! exports provided: initSphere */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSphere", function() { return initSphere; });
var initSphere = function initSphere() {
  ...
  var util = {
    ...
    degreesToRads: function degreesToRads(degress) {
  ...
  var turnSpeed = 0.01;
  var particles = [];
  var Particle = function Particle(add) {
    var theta;
    if (add === true) {
      theta = Math.PI / 2;
    } else {
  ...
  function loop() {
    ...
    for (var _i = 0; _i < particles.length; _i++) {
      ...
      if (_p.m > 0) {
        context.save();
        context.globalAlpha = _p.op;
        context.drawImage(_p.img, _p.x * _p.m + CenterX, CenterY - _p.y * _p.m, _p.radius * _p.m * 2, _p.radius * _p.m * 2);
        context.restore();
