...
/* harmony import */ var _modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-navigation-changer */ "./js/modules/init-navigation-changer.js");
/* harmony import */ var _modules_init_sphere__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-sphere */ "./js/modules/init-sphere.js");
/* harmony import */ var _modules_init_hover3d__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-hover3d */ "./js/modules/init-hover3d.js");
/* harmony import */ var _modules_init_map__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-map */ "./js/modules/init-map.js");
/* harmony import */ var _modules_init_more_item_onclick__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-more-item-onclick */ "./js/modules/init-more-item-onclick.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  //   initSphere();
  // }, 3000);
  Object(_modules_init_sphere__WEBPACK_IMPORTED_MODULE_7__["initSphere"])();
  Object(_modules_init_hover3d__WEBPACK_IMPORTED_MODULE_8__["initHover3d"])();
  Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_5__["initMenu"])();
  Object(_modules_init_navigation_changer__WEBPACK_IMPORTED_MODULE_6__["initNavigationChanger"])();
  // animeElViewportScroll();
  Object(_modules_init_more_item_onclick__WEBPACK_IMPORTED_MODULE_10__["initMoreItemOnclick"])();
  window.addEventListener('load', function () {
    Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_4__["initPreloader"])();
    Object(_modules_init_map__WEBPACK_IMPORTED_MODULE_9__["initMapBlock"])();
...
/*!**********************************!*\
  !*** ./js/modules/init-anime.js ***!
  \**********************************/
/*! exports provided: animeIntro, animeElViewportScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animeIntro", function() { return animeIntro; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animeElViewportScroll", function() { return animeElViewportScroll; });
...
var animeIntro = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
  ...
  translateX: [1000, 0],
  opacity: [0, 1],
  delay: Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["stagger"])(500)
}).add({
...
var animeElViewportScroll = function animeElViewportScroll() {
  var blocks = document.querySelectorAll('[data-animate-block]');
  window.addEventListener('scroll', viewportAnimation);
  function viewportAnimation() {
    var scrollY = window.pageYOffset;
    blocks.forEach(function (current) {
      var viewportHeight = window.innerHeight;
      var triggerTop = current.offsetTop + viewportHeight * 0.2 - viewportHeight;
      var blockHeight = current.offsetHeight;
      var blockSpace = triggerTop + blockHeight;
      var inView = scrollY > triggerTop && scrollY <= blockSpace;
      var isAnimated = current.classList.contains('ss-animated');
      if (inView && !isAnimated) {
        var animeUp = Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["timeline"])({
        ...
        animeUp.add({
          opacity: [0, 1],
          translateY: [500, 0],
          delay: Object(_vendor_anime__WEBPACK_IMPORTED_MODULE_0__["stagger"])(400, {
            start: 200
          }),
...
var initMenu = function initMenu() {
  ...
  var nav = menu.querySelector('.header__nav');
  var burger = nav.querySelector('.header__nav-toggle');
  var links = nav.querySelectorAll('.header__nav-item a');
...
/*!**********************************************!*\
  !*** ./js/modules/init-more-item-onclick.js ***!
  \**********************************************/
/*! exports provided: initMoreItemOnclick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMoreItemOnclick", function() { return initMoreItemOnclick; });
var initMoreItemOnclick = function initMoreItemOnclick() {
  var work = document.querySelector('.works');
  if (!work) {
    return;
  }
  var MOBILE_WIDTH = window.matchMedia('(max-width:767px)');
  var DESCTOP_WIDTH = window.matchMedia('(min-width:768px)');
  var btnShowMore = work.querySelector('[data-btn="more"]');
...
/* harmony import */ var _modules_init_anime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/init-anime */ "./js/modules/init-anime.js");
...
var initPreloader = function initPreloader() {
  ...
  _modules_init_anime__WEBPACK_IMPORTED_MODULE_0__["animeIntro"].play();
  setTimeout(function () {
    preloader.remove();
  }, 1000);
};
